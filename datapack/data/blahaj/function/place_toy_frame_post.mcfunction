# Copy item from frame to display entity
data modify entity @s item set from entity @e[type=minecraft:item_frame,limit=1,sort=nearest,tag=blahaj_frame_temp] Item
...
advancement grant @p[distance=..5] only blahaj:on_display
